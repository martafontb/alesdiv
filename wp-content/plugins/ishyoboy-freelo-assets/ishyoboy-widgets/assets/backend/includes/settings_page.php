...
// Add an option page
if ( is_admin() ) {
	add_action('admin_menu', 'ishfreelotheme_twitter_widget_menu');
	add_action('admin_init', 'ishfreelotheme_twitter_widget_register_settings');
}

function ishfreelotheme_twitter_widget_menu() {
	add_options_page( __( 'IshYoBoy Twitter Widget Options', 'ishyoboy_assets' ), __( 'Twitter Options', 'ishyoboy_assets' ), 'manage_options', 'ishfreelotheme_twitter_widget_settings', 'ishfreelotheme_twitter_widget_settings_output');
}

function ishfreelotheme_twitter_widget_settings() {
	$tdf = array();
...
function ishfreelotheme_twitter_widget_register_settings() {
	$settings = ishfreelotheme_twitter_widget_settings();
...
function ishfreelotheme_twitter_widget_settings_output() {
	$settings = ishfreelotheme_twitter_widget_settings();
...
<li>Log in with your twitter account</li><li>Click on the "Create New App" button or use an already existing one.</li>
