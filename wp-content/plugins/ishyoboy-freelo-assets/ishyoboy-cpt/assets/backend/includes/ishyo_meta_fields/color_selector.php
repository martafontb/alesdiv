...
//$param['value'] = ishfreelotheme_get_theme_colors_array();
$param['value'] = array_merge( array( esc_html__( 'No Color', 'ishyoboy_assets' ) => ''), ishfreelotheme_get_theme_colors_array() );
...
echo apply_filters( 'ishfreelotheme_meta_color_selector_output', $param_line );