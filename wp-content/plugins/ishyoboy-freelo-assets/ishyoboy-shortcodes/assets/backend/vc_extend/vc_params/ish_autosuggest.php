...
$param_line .= '<input name="'.$param['param_name'].'" class="wpb_vc_param_value wpb-textinput '.$param['param_name'].' '.$param['type'].' ish-real-field" type="hidden" value="'. esc_attr( $value ) .'" />';
$param_line .= '<input class="wpb_vc_param_value wpb-textinput ish-visible-field" type="text" value="' . esc_attr( $nice_vals ) . '" data-source="ish_autosuggest_values_' . $ish_autosuggest_count . '" />';
