...
// Global variables
global $ishfreelotheme_options, $ish_tgg_options;
...
$ish_tgg_options= Array(
	...
	'active_color' => $sc_atts['active_color'],
	'active_text_color' => $sc_atts['active_text_color'],
	'border_color' => $sc_atts['border_color'],
	'contents_color' => $sc_atts['contents_color'],
	'contents_text_color' => $sc_atts['contents_text_color'],
	'contents_border_color' => $sc_atts['contents_border_color'],
	'tag' => $sc_atts['tag'],
	'categories' => '',
);
...
if ( '' != $ish_tgg_options['categories'] ){
	...
	if ( ! empty( $final_cats ) ){
		...
		$return .= '<a href="#all" class="ish-active">' . esc_html__( 'All', 'ishyoboy_assets' ) . '</a>';
