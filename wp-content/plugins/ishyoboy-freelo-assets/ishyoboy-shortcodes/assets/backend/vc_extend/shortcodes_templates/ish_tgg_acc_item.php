...
if ( '' == $sc_atts['active_color'] ) { $sc_atts['active_color'] = $ish_tgg_options['active_color']; }
if ( '' == $sc_atts['active_text_color'] ) { $sc_atts['active_text_color'] = $ish_tgg_options['active_text_color']; }
if ( '' == $sc_atts['border_color'] ) { $sc_atts['border_color'] = $ish_tgg_options['border_color']; }
...
if ( '' == $sc_atts['contents_border_color'] ) { $sc_atts['contents_border_color'] = $ish_tgg_options['contents_border_color']; }
...
$class .= ( '' != $sc_atts['active_color'] ) ? ' ish-active-' . esc_attr( $sc_atts['active_color'] ) : '' ;
$class .= ( '' != $sc_atts['active_text_color'] ) ? ' ish-active-text-' . esc_attr( $sc_atts['active_text_color'] ) : '' ;
$class .= ( '' != $sc_atts['border_color'] ) ? ' ish-border-' . esc_attr( $sc_atts['border_color'] ) : '' ;
$pointer = ( '' == $sc_atts['icon'] ) ? '<i class="pointer ish-icon-right-open"></i>' : '';
$return .= '<' . $sc_atts['tag'] . ' class="ish-tgg-acc-title' . $class . '">' . $pointer . $before . $sc_atts['el_title'] . $after . '</' . $sc_atts['tag'] . '>';
