...
// Global variables
global $tabs_count, $tabs__items_count, $ishfreelotheme_options, $ish_tabs_navigation, $ish_tabs_options, $ish_tabs_active_exists;
...
// Replace the ##ISH_TABS## code with current tabs order
$ish_tabs_navigation = ( $tabs_count > 1 ) ? str_replace( '##ISH_TABS##', 'tabs-' . $tabs_count . '-', $ish_tabs_navigation) : str_replace( '##ISH_TABS##', '', $ish_tabs_navigation);

$tabs_navigation .= $ish_tabs_navigation; // It's content is generated by each ish_tab shortcode
$tabs_navigation .= '</ul></div>';

// Replace the ##ISH_TABS## code with current tabs order
$tabs_content = ( $tabs_count > 1 ) ? str_replace( '##ISH_TABS##', 'tabs-' . $tabs_count . '-', $tabs_content) : str_replace( '##ISH_TABS##', '', $tabs_content);
