	...
	'params' => array_merge(
		array(
			array(
				...
				'heading' => __( 'Map Effect', 'ishyoboy_assets' ),
				'param_name' => 'map_effect',
				'value' => array(
					__( 'No effect', 'ishyoboy_assets' ) => '',
					__( 'Inverted', 'ishyoboy_assets' ) => 'inverted',
					__( 'Grayscale', 'ishyoboy_assets' ) => 'grayscale',
				),
				'description' => __( 'Inverted colors add a "nightly" effect since dark colors become light and vice versa. <br>Grayscale effect - colors of map are composed exclusively of shades of gray.', 'ishyoboy_assets' ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Hue of Map', 'ishyoboy_assets' ),
				'param_name' => 'color',
				'value' => array_merge( array( __( 'No Color', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
				'dependency' => Array( 'element' => 'map_effect', 'value' => Array( '', 'inverted' ) ),
			),
			array(
				'type' => 'textfield',
			...
			array(
				...
				'heading' => __( 'Ignore Height on Mobile Devices', 'ishyoboy_assets' ),
				'param_name' => 'ignore_height',
				'value' => array(
					__( 'Yes', 'ishyoboy_assets' ) => '',
					__( 'No', 'ishyoboy_assets' ) => 'no',
				),
				'dependency' => Array( 'element' => 'height', 'not_empty' => true ),
				'description' => __( 'The height will be ignored on mobile devices in responsive view.', 'ishyoboy_assets' ),
			),
		),
		$ish_global_params
	),
