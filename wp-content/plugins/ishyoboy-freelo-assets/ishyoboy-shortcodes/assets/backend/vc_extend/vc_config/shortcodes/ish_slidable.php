	...
	'params' => array_merge(
		array(
			...
			array(
				...
				'dependency' => Array( 'element' => 'navigation', 'value' => Array( '' ) ),
			),
			array(
				'type' => 'ish_buttons_selector_full',
				'heading' => __( 'Navigation Position', 'ishyoboy_assets' ),
				'param_name' => 'nav_position',
				'value' => array(
					__( 'Outside', 'ishyoboy_assets' ) => '',
					__( 'Inside', 'ishyoboy_assets' ) => 'inside',
				),
				'description' => __( 'Choose whether to position the navigation below the slides or inside them.', 'ishyoboy_assets' ),
				'dependency' => Array( 'element' => 'navigation', 'value' => Array( '' ) ),
			),
			array(
			...
			array(
				...
				'std' => 'color2',
				'value' => $ish_theme_colors,
				'dependency' => Array( 'element' => 'prevnext', 'value' => Array( '' ) ),
			),
			array(
				'type' => 'ish_buttons_selector_full',
		...
		array(
			...
			array(
				...
				'value' => array(
					...
					__( 'Repeat', 'ishyoboy_assets') => 'repeat',
				),
				'description' => '',
