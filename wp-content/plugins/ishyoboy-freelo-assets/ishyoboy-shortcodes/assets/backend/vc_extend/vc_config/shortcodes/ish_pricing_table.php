...
vc_map( array(
	...
	'default_content' =>
		'[ish_pricing_row text_content="Pricing Table" text_size="h3" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row text_content="Value 1" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row text_content="Value 2" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row text_content="Value 3" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row text_content="Value 4" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row text_content="Value 5" icon="ish-icon-spin5" button_text="Text on the button" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]
		[ish_pricing_row type="button" text_content="Row Value" icon="ish-icon-spin5" button_text="Button" url="url:%23||" button_size="small" color="color5" text_color="color4" button_icon_align="left" tooltip_color="color1" tooltip_text_color="color3"]',
	...
	'params' => array_merge(
		array(
			...
			array(
				...
				'param_name' => 'ti_text_color', // Text, Icon Text Color
				'std' => '',
				'value' => array_merge( array( __( 'No Color', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
				'dependency' => Array( 'element' => 'type', 'value' => Array( '', 'icon' ) ),
			),
