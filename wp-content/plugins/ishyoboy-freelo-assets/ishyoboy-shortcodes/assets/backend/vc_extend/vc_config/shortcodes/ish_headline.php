...
vc_map( array(
	'name' => esc_html__( 'Headline', 'ishyoboy_assets' ),
	'base' => 'ish_headline',
	'class' => '',
	...
	'params' => array_merge(
		array(
			...
			array(
				...
				'heading' => __( 'Underline Links inside Headline', 'ishyoboy_assets' ),
				'param_name' => 'underline_links',
				'value' => array(
					__( 'Yes', 'ishyoboy_assets' ) => 'yes',
					__( 'No', 'ishyoboy_assets' ) => 'no',
				),
				'description' => __( 'Remove the underline if links are used inside the headline.', 'ishyoboy_assets' ),
