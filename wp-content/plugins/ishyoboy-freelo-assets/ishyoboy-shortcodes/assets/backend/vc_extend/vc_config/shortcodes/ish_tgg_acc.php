	...
	'params' => array_merge(
		array(
			array(
				...
				'heading' => __( 'Behavior', 'ishyoboy_assets' ),
				'param_name' => 'behavior',
				'value' => Array(
					__( 'Toggle', 'ishyoboy_assets' ) => '',
					__( 'Accordion', 'ishyoboy_assets' ) => 'accordion',
				),
				'description' => __( 'Accordion allows only one opened item. Toggle allows multiple.', 'ishyoboy_assets' ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Navigation Background Color', 'ishyoboy_assets' ),
				'param_name' => 'color',
				'std' => 'color6',
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Navigation Text Color', 'ishyoboy_assets' ),
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Active Navigation Background Color', 'ishyoboy_assets' ),
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Active Navigation Text Color', 'ishyoboy_assets' ),
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Navigation Border Color', 'ishyoboy_assets' ),
				'param_name' => 'border_color',
				'value' => array_merge( array( __( 'No Color', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Item Background Color', 'ishyoboy_assets' ),
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Item Text Color', 'ishyoboy_assets' ),
				'param_name' => 'contents_text_color',
				'value' => array_merge( array( __( 'No Color', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Item Border Color', 'ishyoboy_assets' ),
				'param_name' => 'contents_border_color',
				'value' => array_merge( array( __( 'No Color', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_buttons_selector_full',
	...
	'params' => array_merge(
		array(
			...
			array(
				...
				'heading' => __( 'Navigation Background Color', 'ishyoboy_assets' ),
				'param_name' => 'color',
				'value' => array_merge( array( __( 'Inherit from parent container', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Navigation Text Color', 'ishyoboy_assets' ),
			...
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Content Background Color', 'ishyoboy_assets' ),
				'param_name' => 'contents_color',
				'value' => array_merge( array( __( 'Inherit from parent container', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Content Text Color', 'ishyoboy_assets' ),
				'param_name' => 'contents_text_color',
				'value' => array_merge( array( __( 'Inherit from parent container', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
			array(
				'type' => 'ish_color_selector',
				'heading' => __( 'Content Border Color', 'ishyoboy_assets' ),
				'param_name' => 'contents_border_color',
				'value' => array_merge( array( __( 'Inherit from parent container', 'ishyoboy_assets' ) => 'none'), $ish_theme_colors ),
			),
		),
