...
window.IshIconTextView = vc.shortcode_view.extend({

    changeShortcodeParams:function (model) {

        var params = model.get('params');
        window.IshIconTextView.__super__.changeShortcodeParams.call(this, model);
        ...
        if ( _.isObject( params ) ) {
            ...
            if ( ( 'undefined' != typeof params.add_icon ) && ( '' != params.add_icon ) ){

                // Icon
                if ( 'icon' == params.add_icon ){

                    // Set Color
                    if ( ( 'undefined' != typeof params.i_color ) && ( '' != params.i_color ) && ( 'advanced' != params.i_color)  ){
                        sc_class += 'ish-' + params.i_color;
                    }

                    // Set Icon
                    if ( ( 'undefined' != typeof params.i_icon ) && '' != params.i_icon ){
                        sc_class += ' ' + params.i_icon;
                    }
                ...
                // SVG Icon
                else if ( 'svg' == params.add_icon ){

                    // Set Color
                    if ( ( 'undefined' != typeof params.svgi_color ) && ( '' != params.svgi_color ) && ( 'advanced' != params.svgi_color)  ){
                        sc_class += 'ish-' + params.svgi_color;
                    }

                    // Set Icon
                    if ( ( 'undefined' != typeof params.svgi_icon ) && '' != params.svgi_icon ){
                        sc_class += ' ish-svg-container';

                        wrapper.find('.ish-svg-icon').remove();

                        var icon_data = params.svgi_icon.split('/');
