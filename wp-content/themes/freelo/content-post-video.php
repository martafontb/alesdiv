		...
		<div
			...
			<div class="ish-vc_row_inner">
				<div class="ish-display-table">
					...
					// content of post
					$ish_post_content = '';
					$ish_post_content .= '<div class="ish-post-content' . $ish_color_data['bg_class'] . $ish_color_data['text_class'] . ' ish-grid6">';
					...
					if ( $ishfreelotheme_blog_post_order % 2 ) {
						...
						ishfreelotheme_the_post_video(get_the_ID(), $ish_tagline_bg_color, $ish_tagline_text_color, '2columns');
					} else {
						ishfreelotheme_the_post_video(get_the_ID(), $ish_tagline_bg_color, $ish_tagline_text_color, '2columns');
						echo apply_filters( 'ishfreelotheme_post_content_output', $ish_post_content );
					}
		...
		<div
			...
			<div class="ish-vc_row_inner">
				...
				<div class="ish-post-content">
					...
					<?php ishfreelotheme_the_post_video(get_the_ID(), $ish_tagline_bg_color, $ish_tagline_text_color, 'classic'); ?>
