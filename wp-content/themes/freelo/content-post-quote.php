...
if ( ! is_single() ) { ?>
	...
	<?php
	global $wp_query, $ishfreelotheme_blog_post_order, $ish_blog_style, $ish_post_per_page, $ish_post_current;
		...
		<div
			...
			<div class="ish-vc_row_inner">
				<div class="ish-display-table">
					...
					// media of post
					$ish_post_media = '';
					$ish_post_media .= '<div class="ish-post-media ish-grid6' . $ish_tagline_bg_color . $ish_tagline_text_color . '">';


					if ( '' != ishfreelotheme_get_post_format_quote() ) {
						...
						if ( '' != $quote ) {
							...
							if ( '' != $quote_url ) {
								$ish_post_media .= '<a href="' . $quote_url . '" class="ish-link-media">';
							}
							else {
								$ish_post_media .= '<a href="' . get_permalink() . '" class="ish-link-media">';
							}
							$ish_post_media .= '<blockquote class="ish-sc-element ish-sc_quote ish-h3 ish-center ish-blog-quote-content">';
							$ish_post_media .= $quote;
							$ish_post_media .= '</blockquote>';
							$ish_post_media .= '</a>';
						...
						if ( has_post_thumbnail() ) {
							...
							$ish_post_media .= '<div class="ish-blog-post-media">';
								$ish_post_media .= '<a href="' . get_permalink() . '" class="ish-link-media">';
									$ish_post_media .= '<h3 class="ish-format-link-url ish-h5 ish-link-read-more">';
	...
	// CLASSIC
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'wpb_row vc_row-fluid ish-row-notfull ish-row_notsection '. $ish_last_post_in_page ); ?>>
			<div class="ish-vc_row_inner">
				...
				<div class="ish-post-content">
					...
					<?php
					if ( 'true' == $display_taglines && ('' != $tagline_1 || '' != $tagline_2 ) ) {
						if ( '' != $tagline_1 ){ echo '<h2 class="ish-h3"><a href="' . get_the_permalink() . '">' . $tagline_1 . '</a></h2>'; }
						/* if ( '' != $tagline_2 ){ echo '<h3 class="ish-h5">' . $tagline_2 . '</h3>'; } */
					} else {
						?>
					...
					$quote = ishfreelotheme_get_post_format_quote();
					if ('' != $quote){
						echo '<blockquote class="ish-sc-element ish-sc_quote ish-h3 ish-blog-quote-content ' . $ish_color_data['text_class'] .'">';
