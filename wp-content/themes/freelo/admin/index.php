...
if(( isset($cur_language) && $smof_wpml_default_lng != $cur_language) && 'all' != $cur_language && "" != $cur_language)
{
    ...
    define( 'ISHFREELOTHEME_LNG', $cur_language);
    define( 'ISHFREELOTHEME_PREFIX', $smof_wpml_prefix);
}else{
    define( 'ISHFREELOTHEME_LNG', '');
    define( 'ISHFREELOTHEME_PREFIX', '');
}

define( 'SMOF_VERSION', '1.4.2' );
define( 'ADMIN_PATH', get_template_directory() . '/admin/' );
define( 'ADMIN_DIR', get_template_directory_uri() . '/admin/' );
define( 'LAYOUT_PATH', get_template_directory() . '/admin/layouts/' );
...
define( 'GENERATEDCSS_BASE', 'ishfreelotheme_generated_css_version');
...
if (is_admin() && isset($_GET['activated'] ) && $pagenow == "themes.php" ) {
	...
	add_action( 'admin_head', 'ishfreelotheme_woocommerce_colors_setup');
}
...
// Added by IshYoBoy
if ( ! function_exists( 'ishfreelotheme_admin_bar_render' ) ) {
    function ishfreelotheme_admin_bar_render() {
...
add_action( 'wp_before_admin_bar_render', 'ishfreelotheme_admin_bar_render');
