...
$ishfreelotheme_id_404 = ( isset( $ishfreelotheme_options['page_for_404'] ) ) ? $ishfreelotheme_options['page_for_404'] : '';
$sidebar_position = ishfreelotheme_get_sidebar_position($ishfreelotheme_id_404);
	...
	<div class="ish-grid4 ish-main-sidebar ish-<?php echo esc_attr( $sidebar_position . '-sidebar' . $sidebar_resp_center ); ?>" id="sidebar">
		<div class="ish-row ish-row-notfull">
			<div class="ish-row_inner">
				...
				<?php $sidebar = ishfreelotheme_get_sidebar($ishfreelotheme_id_404); ?>
